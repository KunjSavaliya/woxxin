    ...
    <>
      ...
      <div className='flex flex-wrap gap-5 p-6 mt-10 lg:p-0 justify-evenly'>
        ...
        <div>
          ...
          <div className='flex flex-wrap justify-center gap-3 lg:justify-start mt-7'>
            <Button text="Learn More" className="mt-5 text-white bg-[#373435]" />
            <VideoButton text="Learn More" className="mt-5 text-white bg-[#373435]" />
          </div>
        </div>
      </div>
      <div className='flex flex-wrap gap-5 p-6 mt-10 lg:p-0 justify-evenly'>
        ...
        <div>
          <img src='/HomePages/converting1.png' className='w-auto h-[250px] sm:h-[300px] md:h-[300px] lg:h-[350px] xl:h-[400px]' alt='hello'></img>
        </div>
      </div>

      <div className='flex flex-wrap gap-5 p-6 mt-10 lg:p-0 justify-evenly'>
        <div>
          <img src='/HomePages/converting2.png' className='w-auto h-[250px] sm:h-[300px] md:h-[300px] lg:h-[350px] xl:h-[400px]' alt='hello'></img>
        </div>
        <div>
          <Text size={'text-xl md:text-4xl lg:text-5xl xl:text-[42px] text-start'}>
          Banners
